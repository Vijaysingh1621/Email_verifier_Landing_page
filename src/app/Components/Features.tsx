      ...
      <div className="max-w-7xl mx-auto lg:grid lg:grid-cols-2 flex-row">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 rounded-2xl p-6 backdrop-blur-xl"
            >
              <div className="bg-gray-700/30 w-12 h-12 rounded-xl flex items-center justify-center mb-4 text-gray-300">
                {feature.icon}
              </div>
